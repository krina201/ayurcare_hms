...
@section('content')
    ...
    <main class="p-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div id="pageHeader" class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-ayur-brown-600">Update medicine information and inventory details.</p>
                    </div>
            ...
            <!-- EDIT MEDICINE FORM -->
            <div id="editMedicineForm" class="bg-white rounded-xl shadow-lg p-6">
                <form id="medicine-form" method="POST" action="{{ route('pharmacy.update', $medicine->id) }}" novalidate>
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Medicine Type *</label>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Manufacturer *</label>
                            ...
                            <div>
                                ...
                                <input type="text" name="supplier_name" id="supplier_name"
                                    value="{{ old('supplier_name', $medicine->supplier_name) }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Supplier Contact
                                    *</label>
                                <input type="tel" name="supplier_contact" id="supplier_contact"
                                    value="{{ old('supplier_contact', $medicine->supplier_contact) }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Supplier Email *</label>
                                <input type="email" name="supplier_email" id="supplier_email"
                                    value="{{ old('supplier_email', $medicine->supplier_email) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="strength_dosage" id="strength_dosage"
                                    value="{{ old('strength_dosage', $medicine->strength_dosage) }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Unit of Measurement
                                    *</label>
                                <select name="measurement_id" id="measurement_id"
                                    ...
                                    @foreach ($measurements as $measurement)
                                        <option value="{{ $measurement->id }}"
                                            {{ old('measurement_id', $medicine->measurement_id) == $measurement->id ? 'selected' : '' }}>
                                            {{ $measurement->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Main Ingredients
                                    *</label>
                                <textarea rows="3" name="main_ingredients" id="main_ingredients"
                                    ...
                                    placeholder="List main Ayurvedic herbs and ingredients" required="">{{ old('main_ingredients', $medicine->main_ingredients) }}</textarea>
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Indications &amp; Usage
                                    *</label>
                                <textarea rows="3" name="indications_usage" id="indications_usage"
                                    ...
                                    placeholder="Describe what conditions this medicine treats and how to use it" required="">{{ old('indications_usage', $medicine->indications_usage) }}</textarea>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Batch Number *</label>
                            ...
                            <div>
                                ...
                                <input type="date" name="manufacturing_date" id="manufacturing_date"
                                    value="{{ old('manufacturing_date', $medicine->manufacturing_date ? \Carbon\Carbon::parse($medicine->manufacturing_date)->format('Y-m-d') : '') }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Expiry Date *</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Current Stock
                                    Quantity</label>
                                <input type="number" name="initial_stock_quantity" id="initial_stock_quantity"
                                    value="{{ old('initial_stock_quantity', $medicine->initial_stock_quantity ?? $medicine->initial_stock_quantity) }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Minimum Stock Level
                                    *</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Storage Location
                                    *</label>
                                <input type="text" name="storage_location" id="storage_location"
                                    value="{{ old('storage_location', $medicine->storage_location) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Purchase Price *</label>
                                <div class="relative">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Selling Price *</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center">
                                        <span class="text-gray-500">₹</span>
                                    </div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Tax Rate (%)</label>
                                <select name="tax_rate" id="tax_rate"
                                    ...
                                    <option value="0"
                                        {{ old('tax_rate', $medicine->tax_rate) == '0' ? 'selected' : '' }}>0% (Exempt)
                                    </option>
                                    <option value="5"
                                        {{ old('tax_rate', $medicine->tax_rate) == '5' ? 'selected' : '' }}>5% GST</option>
                                    <option value="12"
                                        {{ old('tax_rate', $medicine->tax_rate) == '12' ? 'selected' : '' }}>12% GST
                                    </option>
                                    <option value="18"
                                        {{ old('tax_rate', $medicine->tax_rate) == '18' ? 'selected' : '' }}>18% GST
                                    </option>
                                </select>
                                @error('tax_rate')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-ayur-brown-700 mb-2">Storage Instructions
                                    *</label>
                                <textarea rows="3" name="storage_instructions" id="storage_instructions"
                                    ...
                                    placeholder="Store in a cool, dry place away from direct sunlight" required="">{{ old('storage_instructions', $medicine->storage_instructions) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea rows="3" name="side_effects_precautions" id="side_effects_precautions"
                                    ...
                                    placeholder="List any known side effects and precautions" required="">{{ old('side_effects_precautions', $medicine->side_effects_precautions) }}</textarea>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea rows="2" name="notes" id="notes"
                                    ...
                                    placeholder="Any additional notes about this medicine">{{ old('notes', $medicine->notes) }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="status" id="status" value="1"
                                        class="sr-only peer" {{ old('status', $medicine->status) ? 'checked' : '' }}>
                                    <div
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                // Current stock quantity validation
                const currentStock = fields.initial_stock_quantity && fields.initial_stock_quantity.value;
                clearError('initial_stock_quantity');
                if (currentStock !== '' && currentStock !== null && parseInt(currentStock) < 0) {
                    showError('initial_stock_quantity', 'Current stock quantity must be non-negative.');
                    valid = false;
                }
            ...
            if (manufacturingDateField && expiryDateField) {
                // Set initial min date if manufacturing date exists
                if (manufacturingDateField.value) {
                    expiryDateField.setAttribute('min', manufacturingDateField.value);
                }
