    ...
    <section class="section mt-5">
        <div class="row">
            <div class="col-12">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('saveChangePassword', $user->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="password" name="current_password" id="current_password"
                                        class="form-control mb-2" placeholder="Current Password">
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{ url('/admin/dashboard') }}" id="kt_ecommerce_add_user_cancel"
